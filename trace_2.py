...
"""
Now I need to work to generate text file of true FRET state output to then input here --> then 
work to start writing RMSD function that works on two pandas data frames and compares
column to column
"""